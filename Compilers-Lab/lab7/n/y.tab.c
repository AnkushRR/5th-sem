...
#line 116 "cal.y"
	{
yyval.c = new_node('*',yystack.l_mark[-2].c->value*yystack.l_mark[0].c->value,yystack.l_mark[-2].c,yystack.l_mark[0].c);
}
break;
case 6:
#line 121 "cal.y"
