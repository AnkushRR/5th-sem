...
#define YYSTYPE_IS_DECLARED 1
typedef union { struct node *c ;} YYSTYPE;
...
#line 98 "cal.y"
	{
	   ...
	   inorder(yystack.l_mark[0].c);
       printf("\nPre-Order traversal of the parse-tree:\n");
       preorder(yystack.l_mark[0].c);
           printf("\n\n");
         }
break;
case 5:
#line 111 "cal.y"
	{
	   yyval.c = new_node('E',yystack.l_mark[-2].c->value*yystack.l_mark[0].c->value,yystack.l_mark[-2].c,new_op_node('*'),yystack.l_mark[0].c);
         }
break;
case 6:
#line 116 "cal.y"
...
#line 131 "cal.y"
	{
         yyval.c = new_node('E',yystack.l_mark[0].c->value,NULL,yystack.l_mark[0].c,NULL);
         }
break;
case 10:
#line 138 "cal.y"
	{
           yyval.c = new_node('D',yystack.l_mark[0].c->value,NULL,yystack.l_mark[0].c,NULL);
         }
break;
#line 518 "y.tab.c"
    }
