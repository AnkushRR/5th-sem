...
static const YYINT yysindex[] = {                         0,
 -246,   -8,  -57,    1,    0, -243,    0,    0,    0,  -42,
    0, -243, -243, -243, -243,  -42,    0,    0,    0,    0,
};
...
static const YYINT yytable[] = {                         14,
   12,    5,   13,    6,   15,   17,   18,   19,   20,    2,
    7,    4,    3,    8,    9,   10,   10,
};
static const YYINT yycheck[] = {                         42,
   43,   10,   45,   61,   47,   12,   13,   14,   15,  256,
   10,   10,  259,  257,  258,   10,    6,
};
#define YYFINAL 1
#ifndef YYDEBUG
#define YYDEBUG 0
